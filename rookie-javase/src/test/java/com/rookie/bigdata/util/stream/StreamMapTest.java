...
class StreamMapTest {
    ...
    public void flatMap() throws Exception {
        ...
        Stream<String> lines = Files.lines(Paths.get("C:\\work\\IDEAWorkSpace\\rookie-project\\rookie-github\\rookie-javases\\rookie-javase\\src\\main\\java\\com\\rookie\\bigdata\\lang\\reflect\\Person.java"), StandardCharsets.UTF_8);
        //将数据按照空格进行分割
